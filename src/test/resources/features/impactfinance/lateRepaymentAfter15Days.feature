...
Feature: Late Repayment after 15 days for Impact Finance
  ...
  Scenario: Late Repayment after 15 days for Impact Finance
    ...
    When I actualize created loan on 2018-12-28
    Then cloud should response with code 200
    And message should be Actualize loan started

    When I make NORMAL_REPAYMENT for 115383.23 on 2018-12-28
    Then cloud should response with code 200
    And request should be created
    And not appear in Maker/Checker tab
...
"""
{
  ...
  "rows" : [ {
    ...
    "overdue" : "OVERDUE",
    "data" : [ 3, "2019-01-14", 96258.23, 12175.95, 6493.84, 0.00, 6493.84, 101940.34, 811730.13 ],
    "status" : "PARTIALLY_PAID"
  }, {
    "overdue" : "OVERDUE",
    "data" : [ 4, "2019-02-12", 97702.10, 10732.08, 0, 0.00, 0.00, 108434.18, 715471.90 ],
    "status" : "UNPAID"
  }, {
    "overdue" : "OVERDUE",
    "data" : [ 5, "2019-03-12", 99167.63, 9266.55, 0, 0.00, 0.00, 108434.18, 617769.80 ],
    "status" : "UNPAID"
  }, {
    "overdue" : "OVERDUE",
    "data" : [ 6, "2019-04-12", 100655.15, 7779.03, 0, 0.00, 0.00, 108434.18, 518602.17 ],
    "status" : "UNPAID"
  }, {
    "overdue" : "OVERDUE",
    "data" : [ 7, "2019-05-13", 102164.97, 6269.21, 0, 0.00, 0.00, 108434.18, 417947.02 ],
    "status" : "UNPAID"
  }, {
    "overdue" : "OVERDUE",
    "data" : [ 8, "2019-06-12", 103697.45, 4736.73, 0, 0.00, 0.00, 108434.18, 315782.05 ],
    "status" : "UNPAID"
  }, {
    "overdue" : "OVERDUE",
    "data" : [ 9, "2019-07-12", 105252.91, 3181.27, 0, 0.00, 0.00, 108434.18, 212084.60 ],
    "status" : "UNPAID"
  }, {
    "overdue" : "OVERDUE",
    "data" : [ 10, "2019-08-12", 106831.69, 1602.48, 0, 0.00, 0.00, 108434.17, 106831.69 ],
    "status" : "UNPAID"
  } ],
  "totals" : [ null, null, 1000000.00, 84341.79, 35092.33, 188269.87, 35092.33, 860979.59, null ]
}
"""
    When I rollback on 2018-12-28
    Then cloud should response with code 200
    And schedule should like this
"""
{
  ...
  "rows" : [ {
    ...
    "overdue" : "OVERDUE",
    "data" : [ 2, "2018-12-12", 94835.69, 13598.49, 13598.49, 0.00, 0.00, 108434.18, 906565.82 ],
    "status" : "UNPAID"
  }, {
    "overdue" : "OVERDUE",
    "data" : [ 3, "2019-01-14", 96258.23, 12175.95, 6493.84, 0.00, 0.00, 108434.18, 811730.13 ],
    "status" : "UNPAID"
  }, {
    "overdue" : "OVERDUE",
    "data" : [ 4, "2019-02-12", 97702.10, 10732.08, 0, 0.00, 0.00, 108434.18, 715471.90 ],
  ...
  "totals" : [ null, null, 1000000.00, 84341.79, 35092.33, 93434.18, 15000.00, 975907.61, null ]
}
"""